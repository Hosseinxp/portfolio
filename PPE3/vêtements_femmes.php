...
<header>
    <div id="menu">
        <nav>
            ...
            <a href="vêtements_femmes.php"><button class="btn-nav" style="background-color: rgb(  72, 201, 176  );">Vêtements femmes</button></a>
...
<body>
    <div class="div_vêtements">
        ...
        <div class="vêtements" style="transform: translateX(5vw) translateY(7vw);">
            ...
            <img src="Pantalon_.jpg" class="img_vêtements">
            <div class="selection">
                Quantité : 
                <select>
                    <option>1</option>
        ...
        <button class="btn-achat" style="transform: translateX(6.3vw) translateY(6vw);">Payer : 29,99€</button>
        ...
        <div class="vêtements" style="transform: translateX(30vw) translateY(-23.2vw);">
            ...
            <img src="Veste_.jpg" class="img_vêtements">
        ...
        <button class="btn-achat" style="transform: translateX(31vw) translateY(-24.2vw);">Payer : 25,99€</button>

        <!------------------- Rubrique chemise ------------------->


        <div class="vêtements" style="transform: translateX(55vw) translateY(-53.6vw);">
            <p class="p-vêtements">Robe</p>
            <img src="Robe_.png" class="img_vêtements">
    ...
    <button class="consultation_stock">Consultation stock vêtements femmes</button>
</body>
</html>